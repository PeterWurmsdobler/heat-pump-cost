...
My final note on the whole series on the adoption of heat pumps in the UK are two factors: 1) compact and simple to install units, like appliances (and cheap), 2) energy management software to allow exploiting dynamic tariffs due to the large spark gap.
